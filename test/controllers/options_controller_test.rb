...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { choice: @option.choice, field_id: @option.field_id, student_id: @option.student_id }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { choice: @option.choice, field_id: @option.field_id, student_id: @option.student_id }
    assert_redirected_to option_path(assigns(:option))
  end
